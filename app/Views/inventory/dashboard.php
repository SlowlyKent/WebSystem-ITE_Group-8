...
<div class="layout">
    <aside class="sidebar">
        <div class="brand"><i class="fas fa-boxes-stacked"></i><span class="brand-title">INVENTORY DASHBOARD</span></div>
        <div class="avatar"><i class="fas fa-user"></i></div>
        <button class="role">Inventory</button>
        <nav class="nav">
            <a class="active" href="<?= base_url('inventory') ?>"><i class="fas fa-gauge"></i> Dashboard</a>
            <a href="<?= base_url('inventory/manage') ?>"><i class="fas fa-box"></i> Manage Stock</a>
            <a href="<?= base_url('inventory/low-stock') ?>"><i class="fas fa-triangle-exclamation"></i> Low Stock</a>
            <a href="<?= base_url('inventory/expiring') ?>"><i class="fas fa-hourglass-half"></i> Expiring Soon</a>
            <a href="<?= base_url('inventory/reports') ?>"><i class="fas fa-file-waveform"></i> Reports</a>
        </nav>
