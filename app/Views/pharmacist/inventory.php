...
<div class="layout">
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <a class="nav-item active" href="#">Inventory Management</a>
  ...
  <main class="content">
    ...
    <section class="panel">
      <div class="panel-header"><h3>Medicines</h3></div>
      <div class="panel-body">
        <div class="form-actions" style="margin-bottom:10px">
          <a class="btn primary" href="#">Add Medicine</a>
          <a class="btn" style="background:#eef5f1" href="#">Import CSV</a>
        </div>
        <table class="table">
          <thead>
            <tr>
          ...
          <tbody>
            <?php foreach (($items ?? []) as $it): ?>
              <tr>
                <td><?= esc($it['name']) ?></td>
                <td><?= esc($it['stock']) ?></td>
                <td><?= esc($it['expires']) ?></td>
                <td>
                  <a class="btn" href="#">Edit</a>
                  <a class="btn" href="#">Adjust Stock</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
